    ...
    <section className="relative min-h-screen flex items-center">
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-20">
        <div className="max-w-2xl mt-[-20%] md:mt-0 md:pl-0 pl-[10%]">
            ...
            `}</style>
            <p className="text-base md:text-lg mb-8 md:mb-12 text-white max-w-lg blur-effect-left" data-text="Desde el entrenamiento hasta las peleas más importantes, estoy acá para apoyar a quienes sueñan en grande.">
